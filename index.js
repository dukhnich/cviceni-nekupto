...
const card2Btn = document.querySelector('#product2 button');
card2Btn.classList.remove('btn-primary');

const card3Title = document.querySelector('#product3 .card-title');
card3Title.classList.toggle('text-center');
